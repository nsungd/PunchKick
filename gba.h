...
#define SET_PALETTE_ROW(row, colors) DMANow(3, (colors), BG_PALETTE + ((row) * 16), 16)


// Write a single color to an entry in palette row n
#define SET_BG_PAL_COLOR(row, index, color) (BG_PALLETE[((row) * 16) + (index)] = (color))
